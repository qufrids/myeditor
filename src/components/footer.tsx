        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-10 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-6 flex flex-col gap-2.5">
              ...
              <a href="tel:+447478074720" className="flex items-center gap-2.5 text-[13px] text-slate-500 transition-colors hover:text-slate-900 dark:text-slate-500 dark:hover:text-white">
                <Phone className="h-3.5 w-3.5 text-slate-400 dark:text-slate-600" /> +44 7478 074720
              </a>
